...
# TODO: Define a function called 'personalized_greeting' that takes a name as a parameter and prints a personalized greetingdef personalized_greeting(name)
def personalized_greeting(name):
    print("hello " +name)
# TODO: Call the 'personalized_greeting' function with your name
personalized_greeting("sibabalwe")
